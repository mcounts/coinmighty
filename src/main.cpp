...
uint256 hashGenesisBlock("0x7434fbfa78ca965688723b9bf198b6c9409814e8ea047b7423c3211dee9d3fa1");
...
const string strMessageMagic = "CoinMighty Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // CoinMighty: 1 days
static const int64 nTargetSpacing = 900; // CoinMighty: 15 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal coinmighty miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CoinMighty", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa8bb69ff65c0ac14d321d7e7c930d3e3ca7e326427db610bbbe463f621b4bd8d");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "today's headline: New objects sighted as Flight 370 search shifts dramatically";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1396638648;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 388327557;
        ...
        assert(block.hashMerkleRoot == uint256("0xd9743c49bc31732b9023003fd61ffeb107eddec6b9d3f45ad9d1740555642404"));
